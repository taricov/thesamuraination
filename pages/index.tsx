...
<div className="uppercase tracking-tighter font-logoFont text-5xl md:text-[60px]  font-bold ralative flex justify-center ">
...
<section className="bg-white dark:bg-gray-900">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-gray-500 md:mb-5 text-center dark:text-gray-400">It's short, visual, bi-weekly and above all it's a Nation 😺 btw it's free 'cuz we r not selling yogurt here, we just talk.</p>
          <form action="#">
